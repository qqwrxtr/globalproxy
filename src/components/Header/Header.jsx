...
const Header = React.memo(() => {
  ...
  const menuItems = useMemo(
    () => ["Offers", "Features", "Dashboard", "Support"],
    [],
  );
    ...
    <div className="container container_header">
      ...
      >
        <div className="container-fluid">
          ...
          <motion.div
            className="d-flex align-items-center ms-auto order-xl-3"
            variants={itemVariants}
          >
          ...
          <motion.div
            className="collapse navbar-collapse order-xl-2 d-xl-block d-none"
