...
const InfoBlock = React.memo(() => {
  ...
  return (
    <div
      className="container container_info w-100 d-flex align-items-center justify-content-center"
      style={{ padding: "50px 20px 0", overflow: "visible" }}
    >
      <motion.div
      ...
      >
        <div className="col-12 bg_color pt-4">
          <div className="row d-flex justify-content-center w-100 flex-xxl-nowrap flex-xl-nowrap flex-lg-wrap row_blocks">
            <motion.div
              className="info_block col-xxl-2 col-xl-2 col-lg-4 col-md-4 col-sm-12"
            ...
            >
              <div className="title_info_abt">
                <p>
                  <CountUp end={35} decimals={0} /> + Mbps
                </p>
              </div>
              <div className="subtitle_info_abt">
                <p>{t("Port_Speed")}</p>
            ...
            <motion.div
              className="last-row-item col-xxl-2 col-xl-2 col-lg-12 col-sm-12"
              variants={itemVariants}
            >
              <div className="title_info_abt">
                <p>
                  <CountUp end={2} /> + {t("Operators")}
                </p>
              </div>
              <div className="subtitle_info_abt">
                <p>{t("Country")}</p>
